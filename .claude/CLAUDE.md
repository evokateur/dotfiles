...
- Naming
  ...
  - Use pronounceable names, not abbreviations or acronyms
  ...
  - Don't add gratuitous context to variable names, rely on namespacing and structure to provide context
